...
- **Migration Generation**: Timestamped migration files with UTC format and automatic directory creation
...
This will:
1. Parse your SQL schema files with the robust participle-based parser
2. Connect to your ClickHouse instance (if configured)
3. Read the current schema (databases, tables, dictionaries, and views)
...
- `20240101120000.sql` - Contains changes to apply
...
### Migration Ordering
The tool ensures proper operation ordering for migrations:
...
func main() {
    ...
    // Output: Generated migration: 20240806143022.sql

    // Output: Generated migration: 20240806143023.sql
}
```
...
- **Migration Generator**: Creates executable SQL migrations with proper operation ordering
