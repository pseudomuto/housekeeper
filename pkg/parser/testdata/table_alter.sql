...
-- ALTER TABLE MODIFY COLUMN with CODEC
ALTER TABLE events MODIFY COLUMN timestamp DateTime64(3, UTC) CODEC(DoubleDelta);

-- ALTER TABLE MODIFY COLUMN with multiple CODEC specifications
ALTER TABLE events MODIFY COLUMN data String CODEC(Delta, ZSTD);
